...
//     },
//     Starknet {
//         starknet_account: Arc<starknet_keeper::StarknetAccount>,
...
//                 return Ok(());
//             }
//             let found = starknet_keeper::discover_merchants(
//                 starknet_account,
//                 starknet_config,
//                 *registry_watermark,
//                 tip,
...
//             receivers.dedup();
//             let sweep_tx =
//                 match starknet_keeper::multicall_sweep(starknet_account.clone(), &receivers).await {
//                     Ok(tx) => tx,
//                     Err(e) => {
//                         eprintln!("[{}] multicall sweep failed: {e:#}", now_formatted());
//                         None
...
//     let starknet_account = starknet_keeper::build_starknet_account(&starknet_config)?;
...
//                 match starknet_keeper::fetch_deposits_since_block(
//                     &starknet_account,
//                     &starknet_config,
//                     &receiver_keys,
//                     starknet_deposit_watermark,
